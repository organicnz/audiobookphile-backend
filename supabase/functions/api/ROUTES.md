...
| items.ts        | DELETE `/ :id` (admin; atomic DB delete; `hardDelete=1` requests durable B2/cover cleanup), DELETE `/ :id/cover`, POST/PATCH `/ :id/cover`, sync-covers, sync-durations, sync-insights                                                            |
