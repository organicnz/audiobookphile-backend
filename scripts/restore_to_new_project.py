...
print(" 2. Run book cover recovery: deno run --allow-all --env-file=.env supabase/functions/repair_metadata.ts --apply --covers-only")
print(" 3. Run author avatar recovery: deno run --allow-all --env-file=.env scripts/restore_author_avatars.ts")
print(" 4. Verify storage health: deno run --allow-all --env-file=.env scripts/storage_health_report.ts")
print(" 5. Update environment variables in .env and .env.local")
print("="*60)
